...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0B1426] via-[#1e3a8a] via-[#1f2937] to-[#0B1426] flex items-center justify-center p-4 xs:p-6 md:p-8 lg:p-12 xl:p-16 relative overflow-hidden">
      ...
      <div className={`glass-card rounded-2xl xs:rounded-3xl shadow-[0_25px_50px_-12px_rgba(30,64,175,0.3)] border-2 border-[#0ea5e9] p-6 xs:p-8 md:p-10 lg:p-12 xl:p-14 w-full max-w-xs xs:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl relative z-10 hover:shadow-[0_35px_60px_-12px_rgba(14,165,233,0.3)] hover:border-[#38bdf8] transition-all duration-500 before:absolute before:inset-0 before:rounded-2xl xs:before:rounded-3xl before:p-[2px] before:bg-gradient-to-r before:from-[#0ea5e9] before:via-[#1e40af] before:to-[#0ea5e9] before:-z-10 before:opacity-60 ${showCard ? 'animate-slide-in-up' : 'opacity-0'}`}>
        <div className="text-center mb-6 xs:mb-8 lg:mb-10 xl:mb-12">
          <div className="flex items-center justify-center mb-4 xs:mb-6 lg:mb-8 animate-fade-in-scale">
            <div className="w-10 h-10 xs:w-12 xs:h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16 bg-gradient-to-br from-[#fbbf24] to-[#f59e0b] rounded-lg xs:rounded-xl flex items-center justify-center mr-2 xs:mr-3 lg:mr-4 shadow-lg hover:shadow-xl transition-shadow duration-300 animate-pulse-gold border border-[#0ea5e9]/30">
              <span className="text-[#1e40af] font-bold text-lg xs:text-xl lg:text-2xl xl:text-3xl font-montserrat">S</span>
            </div>
            <h1 className="text-2xl xs:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white font-montserrat">SwiftEDU</h1>
          </div>
          <p className="text-[#e2e8f0] font-medium text-sm xs:text-base lg:text-lg xl:text-xl min-h-[1.5rem]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 xs:space-y-5 md:space-y-6 lg:space-y-7 xl:space-y-8">
          <div className="group animate-slide-in-left">
            <label htmlFor="email" className="block text-xs xs:text-sm font-semibold text-white mb-2 xs:mb-3 transition-colors duration-200 group-focus-within:text-[#0ea5e9]">
              Email
            </label>
            <input
              id="email"
          ...
          <div className="group animate-slide-in-right">
            <label htmlFor="password" className="block text-xs xs:text-sm font-semibold text-white mb-2 xs:mb-3 transition-colors duration-200 group-focus-within:text-[#0ea5e9]">
              Senha
            </label>
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-[#1e40af] to-[#0ea5e9] hover:from-[#2563eb] hover:to-[#38bdf8] disabled:bg-[#64748b] text-white font-semibold py-3 xs:py-4 px-4 rounded-lg xs:rounded-xl transition-all duration-500 transform hover:scale-[1.02] hover:shadow-[0_15px_30px_-5px_rgba(14,165,233,0.4)] disabled:transform-none disabled:shadow-none border-2 border-transparent hover:border-[#fbbf24] active:scale-[0.98] font-montserrat relative overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:translate-x-[-100%] hover:before:translate-x-[100%] before:transition-transform before:duration-700 text-sm xs:text-base animate-fade-in-scale"
          >
            {isLoading ? (
        ...
        <div className="mt-6 xs:mt-8 text-center animate-fade-in-scale">
          <p className="text-xs xs:text-sm text-[#cbd5e1] font-medium">
